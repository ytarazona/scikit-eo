...
def calkmeans(image, k = None, algo = ("auto", "elkan"), max_iter = 300, n_iter = 10, nodata = -99999, **kwargs):
    ...
    if k is None:
        ...
        dic = {'inertias_lloyd_k': inertias_intra_lloyd_k,
               'inertias_elkan_k': inertias_intra_elkan_k}
    ...
    # variance = [kmeanlist[i].fit(datos).inertia_ for i in range(len(kmeanlist))]
        ...
        if 'auto' in algo:
            ...
            for i in range(n_iter):
                ...
                inertias_inter_lloyd.append(kmeanModel.inertia_)
        ...
        dic = {'inertias_lloyd_k': inertias_inter_lloyd,
               'inertias_elkan_k': inertias_inter_elkan}
